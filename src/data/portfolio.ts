// All the copy on the site lives here — edit these values to make the
// portfolio your own without touching any component markup.

export const profile = {
  initials: "ME",
  name: "Martin Strand Eikefet",
  role: "Frontend-utvikler & E-sportkonkurrent",
...
export const experience = [
  ...
  {
    year: "2018 – 2024",
    title: "Konkurranse-e-sport — World of Warcraft",
...
export const gaming = {
  ...
  channels: [
    {
      platform: "YouTube",
      name: "VengefulGamingHD",
      stat: "Videoinnhold",
      href: "https://www.youtube.com/@VengefulGamingHD",
    },
    {
      platform: "Twitch",
      name: "Berlyirltv",
